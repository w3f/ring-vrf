...
We model the security of ring VRFs in the universally composable (UC) \cite{canetti1,canetti2} and  prove that our ring VRF protocol is UC secure. Thus, we guarantee strongest security along with practicality.
% First
