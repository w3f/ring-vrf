...
for a relation $\relone$ similar to $\Rring$. In fact, we will instantiate $\relone$ with $\Rring^{\mathtt{inner}}$. \qhandan{}{I think it is better to relate everything below with the current description of the protocol so I suggest the following changes}
