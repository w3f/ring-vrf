...
\input{overview}
\input{background}
%\input{games} it is not complete so it should not be in the conference submission
\input{uc_fun}
\input{uc_model}
...
%We should include the applications in a way that they are convincing, and claims are easily be verified. Therefore, it is better to remove the following tex files and add a review of them in the conclusion section that I added.
\eprint{\input{app_id}}{}
\eprint{\input{app_rate}}{}

\eprint{}{\input{conclusion}}
