...
\begin{definition}\label{def:nizk_zero_knowledge}
	...
	\Pr[& \adv(\crs_\rel, z, \pi,\rel) = 1 \ | \ (\crs_\rel, \tau_\rel) \leftarrow \NIZK_\rel.\Setup (1^{\lambda}),   \pi \leftarrow \NIZK_\rel.\Prove (\crs_\rel, x; \omega)]\\
	=\Pr[& \adv(\crs_\rel, z, \pi,\rel) = 1 \ | \ (\crs_\rel, \tau_\rel) \leftarrow \NIZK_\rel.\Setup (1^{\lambda}),   \pi \leftarrow \NIZK_\rel.\Simulate (\crs_\rel, \tau_\rel, x)]
\end{align*}}
