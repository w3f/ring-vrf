...
We only ever hash-to-$\ecEsis$ because hash-to-$\grE_1$ creates a miss-use
footgun for for privacy.  Also hash-to-$\ecEsis$ is faster.
We let $\Hout$ denote the hash to the VRF output space, usually
