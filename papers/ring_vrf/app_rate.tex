...
tipping points \cite{tipping22}.  % https://www.youtube.com/watch?v=LxoyaCSWFGs
...
% \cite{PrivacyPass}
As in \S\ref{subsec:moderation}, we could impose simultanious rationing
constraints for multiple resources $u_1,\ldots,u_k$ by producing one
ring VRF signature in which \PedVRF proves correctness of pre-ouptuts
