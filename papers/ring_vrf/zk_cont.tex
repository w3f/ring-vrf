...
We now verify $(X' + Y,A',B',C')$ like Groth16 
$$ e(A',B') = e([\alpha]_1, [\beta]_2) \cdot
...
\def\longeq{=\mathrel{\mkern-7mu}=}% {=\joinrel=} % https://tex.stackexchange.com/questions/35404/is-there-a-wider-equal-sign
...
$$ \Lfast = \Setst{ \sk_0 + 2^{128} \sk_1, \comring }{
