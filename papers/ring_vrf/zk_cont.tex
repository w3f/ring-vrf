...
\noindent We prove knowledge-soundness by reducing it to the knowledge soundness property of the commit-carrying 
Groth16 with double binding (for short $\ccgroth$). This knowledge soundness property has been formalised in 
