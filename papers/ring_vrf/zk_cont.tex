...
SNARK $\ccgroth$~\cite[Fig.~22]{LegoSNARK} setup\footnote{$\ccgroth$ is, in turn, based on  Groth16.}.
...
of $\SpecialG$ (i.e., as defined for $\ZKCont$) is weaker than the knowledge soundness property of commit-carrying SNARK with double 
