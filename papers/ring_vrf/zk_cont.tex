...
constructs commitment $X$ and proof $\pi$ for relation $\relone$ from vector of inputs 
$\bar{y}$ (called \emph{transparent}), a vector of inputs $\bar{x}$ (called \emph{opaque}), 
and vector of witnesses $\bar{\omega}$,
...
\end{itemize}
and satisfies completeness w.r.t,  completeness w.r.t,  knowledge soundness and zero-knowledge as defined below:
