...
Below, we formally define ZK continuation. In Section~\ref{sec:rvrf_groth16} we instantiate it via  \SpecialG, and finally, in section~\ref{subsec:rvrf_faster} we use it to instantiate our $ \rVRF.\Sign $ algorithm from Section \ref{sec:pederson_vrf} with fast amortised prover time. \\
