...
\item $\specg.\Sim: (\tw, \bary, \relRQ) \mapsto \pi$ where $u, f, g \xleftarrow {\$} \F_p$ and let \\
...
verifiable, and, hence, according to~\cite{subversion_zk}, subversion zero-knowledge. 
...
\end{theorem}
\begin{proof} It is straightforward to prove that $\specg$ has completeness for $\Preprove$. 
\end{proof}
